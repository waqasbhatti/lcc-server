...
lightcurve-sets.sqlite -> contains:
...
- catalog-datasets.sqlite -> indexes the dataset information
- lcdir/ -> whatever subdir structure here is used
- periodfinding/
- checkplots/
- datasets/{1st 2 chars in setUUID}/{2nd 2 chars in setUUID}/ -> {setUUID}.pkl
